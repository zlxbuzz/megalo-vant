...
var octoParse = __webpack_require__(/*! octoparse */ "./node_modules/octoparse/index.js").default;
...
(function (global, factory) {
  ...
  function getVnode(vnode, hid) {
    ...
    if (componentInstance) {
      ...
      children = Object.keys($slots).reduce(function (res, k) {
        var nodes = $slots[k];
        /* istanbul ignore else */
        if (nodes._rendered) {
...
/***/ "./node_modules/octoparse/index.js":
/*!*****************************************!*\
  !*** ./node_modules/octoparse/index.js ***!
  \*****************************************/
/*! no static exports found */
...
var _index = __webpack_require__(/*! ./lib/index.js */ "./node_modules/octoparse/lib/index.js");

var _index2 = _interopRequireDefault(_index);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.octoParse = _index2.default;
...
var _octoParse = __webpack_require__(/*! ./octoParse */ "./node_modules/octoparse/lib/octoParse.js");

var _mountAction = __webpack_require__(/*! ./mountAction */ "./node_modules/octoparse/lib/mountAction.js");

var _mountAction2 = _interopRequireDefault(_mountAction);
...
var octoparse = {
    ...
    mountAction: _mountAction2.default
};
exports.default = octoparse;
...
exports.install = exports.htmlParse = undefined;

var _html2json = __webpack_require__(/*! ./parse/html2json */ "./node_modules/octoparse/lib/parse/html2json.js");
...
function htmlParse() {
  ...
  var res = {}; //返回的数据
  transData = (0, _html2json.html2json)(data, 'root', options);
...
var inline = makeMap("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,let");
...
exports.html2json = undefined;

var _index = __webpack_require__(/*! ./utils/index */ "./node_modules/octoparse/lib/parse/utils/index.js");

var _htmlparser = __webpack_require__(/*! ./htmlparser */ "./node_modules/octoparse/lib/parse/htmlparser.js");

var _index2 = __webpack_require__(/*! ./constant/index */ "./node_modules/octoparse/lib/parse/constant/index.js");
...
exports.HTMLParser = undefined;

var _index = __webpack_require__(/*! ./constant/index */ "./node_modules/octoparse/lib/parse/constant/index.js");
	...
	while (html) {
		...
		if (!stack.last() || !_index.special[stack.last()]) {
			...
			if (html.indexOf("<!--") == 0) {
				...
				match = html.match(_index.startTag);
				// console.log('match的是', match);
				if (match) {
					html = html.substring(match[0].length);
					// console.log('replace前的是', match[0])	
					match[0].replace(_index.startTag, parseStartTag);
	...
	function parseStartTag(tag, tagName, rest, unary) {
		...
		if (handler.start) {
			...
			rest.replace(_index.attr, function (match, name) {
				...
				var value = arguments[2] ? arguments[2] : arguments[3] ? arguments[3] : arguments[4] ? arguments[4] : _index.fillAttrs[name] ? name : "";
